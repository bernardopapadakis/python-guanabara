...
print('\033[1;34m///'*40)
print('\033[1;30mVou pensar em um número entre 0 e 5. Tente adivinhar!')
print('\033[1;34m///'*40)
sleep(1)
...
if r == n:
    ...
    playsound('C:/pg/estudo/python/curso-em-video/mundo1-fundamentos/aula10-condicoes-parte1/ex028-win.mp3')
else:
    print(f'\033[1;31mVocê errou! Eu tinha pensando em {n}. Tente novamente!')
    playsound('C:/pg/estudo/python/curso-em-video/mundo1-fundamentos/aula10-condicoes-parte1/ex028-loss.wav')